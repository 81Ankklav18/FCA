...
//            "Welcome to YouTube Premium! ";
    ...
    private static final List<String> messagesOfClass1 = new ArrayList<>();
    private static final List<String> messagesOfClass2 = new ArrayList<>();
...
//        Map<Set<String>, Tree> resultNorris = treeNorris.getNorris(getTreeMatrix(class2));
        ...
        System.out.println("++++++++++++++++++++++++++++++");
        List<Tree> treesVal = new ArrayList<>(result.values());
...
//        }
    ...
    public static List<Map<Set<String>, Tree>> getTreeMatrix(List<Tree> objects){
        ...
        o2.add("o2");
        HashSet<String> o3 = new HashSet<>();
        o3.add("o3");
        HashSet<String> o4 = new HashSet<>();
        o4.add("o4");
        HashSet<String> o5 = new HashSet<>();
        o5.add("o5");
        HashSet<String> o6 = new HashSet<>();
        o6.add("o6");
